                    ...
                    <div>
                        ...
                        <Link to={`user-profile/${pinDetail.postedBy?.id}`}
                            ...
                            <img src={pinDetail.postedBy?.image} alt="user-profile"
                                 className="w-8 h-8 rounded-full object-cover rounded-full"/>
                            ...
                            {pinDetail?.comments?.map((comment, i) => (
                                <div className="flex gap-2 mt-5 items-center bg-white rounded-lg" key={i}>
                                    <img src={comment.postedBy.image} alt="user-profile"
                                         className="w-10 h-10 rounded-full curosor-pointer"/>
                        ...
                        <div className="flex flex-wrap mt-6 gap-3">
                            <Link to={`user-profile/${pinDetail.postedBy?.id}`} className="">
                                <img src={pinDetail.postedBy?.image} alt="user-profile"
