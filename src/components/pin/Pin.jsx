    ...
    return (
        <div className="m-2">
                ...
                {postHovered && (
                    ...
                    >
                        ...
                        <div className="flex justify-between gap-2 w-full items-center">
                            ...
                            <button type={"button"}
                                    className="bg-white p-2 opacity-75 hover:opacity-100 text-white font-bold text-black rounded-3xl hover:shadow-md outline-none"
                                    onClick={(e) => {
                                        e.stopPropagation();
                                        deletePin(_id);
                                    }}
            ...
            <Link to={`user-profile/${postedBy?.id}`} className="flex gap-2 mt-2 items-center">
                <img src={postedBy?.image} alt="user-profile" className="w-8 h-8 rounded-full object-cover rounded-full"/>
